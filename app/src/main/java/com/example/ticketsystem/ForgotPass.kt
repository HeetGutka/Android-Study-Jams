...
class ForgotPass : AppCompatActivity() {
    ...
    lateinit var forgot_pass: Button
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        phone=findViewById(R.id.phone_number_forgot_pass)
        forgot_pass=findViewById(R.id.frogot_pSS_BT)
        phoneError=findViewById(R.id.phone_error_forgot_pass)
